...
public class FillableLoaderBuilder {
    ...
    public FillableLoaderBuilder preFillColor(int preFillColor) {
    ...
    public FillableLoader build() {
        ...
        strokeDrawingDuration =
            strokeDrawingDuration < 0 ? res.getInteger(R.integer.strokeDrawingDuration) : strokeDrawingDuration;
        fillDuration = fillDuration < 0 ? res.getInteger(R.integer.fillDuration) : fillDuration;
        clippingTransform = clippingTransform == null ? new PlainClippingTransform() : clippingTransform;
        ...
        return new FillableLoader(parent, params, strokeColor, fillColor, preFillColor, strokeWidth, originalWidth,
            originalHeight, strokeDrawingDuration, fillDuration, clippingTransform, svgPath, percentageEnabled,
            percentage);
    }
