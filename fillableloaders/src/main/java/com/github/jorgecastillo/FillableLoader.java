...
public class FillableLoader extends View {
    ...
    private int strokeColor, fillColor, strokeWidth, preFillColor;
     ...
     */
    FillableLoader(ViewGroup parent, ViewGroup.LayoutParams params, int strokeColor, int fillColor, int preFillColor,
        int strokeWidth, int originalWidth, int originalHeight, int strokeDrawingDuration, int fillDuration,
        ClippingTransform transform, String svgPath, boolean percentageEnabled, float fillPercentage) {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        preFillColor = extractor.getPreFillColor();
    ...
    private void init() {
        if (isInEditMode()) {
            svgPath = "M25,32L31,32L31,26L35,26L28,19L21,26L25,26L25,32Z";
        }
    ...
    private void initPreFillPaint() {
        preFillPaint = new Paint();
        preFillPaint.setAntiAlias(true);
        preFillPaint.setStyle(Paint.Style.FILL);
        preFillPaint.setColor(preFillColor);
    }
    ...
    private float getFillPhaseForPercentage(long elapsedTime) {
        float fillPhase = MathUtil.constrain(0, percentage / 100,
            previousFramePercentage / 100 + ((float) (elapsedTime - previousFramePercentageTime) / fillDuration));
    ...
    public void setPreFillColor(int preFillColor) {
        this.preFillColor = preFillColor;
    }
