...
import com.tomeokin.lspush.biz.home.CollectionWebViewActivity;
...
public interface CollectionWebViewComponent extends ActivityComponent {
    void inject(CollectionWebViewActivity collectionWebViewActivity);
}
