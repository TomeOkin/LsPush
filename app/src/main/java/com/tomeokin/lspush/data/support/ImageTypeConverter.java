 ...
 */
package com.tomeokin.lspush.data.support;
...
public class ImageTypeConverter implements JsonSerializer<Image>, JsonDeserializer<Image> {
    ...
    public Image deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        return gson.fromJson(gson.fromJson(json, String.class), typeOfT);
    }

    @Override
    public JsonElement serialize(Image src, Type typeOfSrc, JsonSerializationContext context) {
        return gson.toJsonTree(gson.toJson(src, typeOfSrc), String.class);
    }
}
